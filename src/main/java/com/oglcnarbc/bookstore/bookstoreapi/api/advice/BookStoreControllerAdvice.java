package com.oglcnarbc.bookstore.bookstoreapi.api.advice;
...
import com.oglcnarbc.bookstore.bookstoreapi.common.model.ErrorResponse;
...
@RestControllerAdvice(annotations = BookStoreApi.class)
@Slf4j
